                  ...
                  child: Stack(
                    children: [
                      Center(
                        child: Text(
                          widget.isCustomer
                              ? widget.customer.phoneNo.toString().replaceFirst("[", "").replaceFirst("]", "") ??
                                  widget.customer.name
                              : widget.lead.phoneNo.toString() ??
                                  widget.lead.phoneNo
                                      .toString()
                                      .replaceAll("[", "")
                                      .replaceAll("]", ""),
                        ...
                        child: Row(
                          ...
                          children: [
                            buildSingleRoundButton(Icons.call, () {
                              // Lead l;
                              try {
                                launch("tel: +91 ${widget.lead.phoneNo[0]}");
                              } catch (e) {
                                print(e);
                              }
                            }),
                            buildSingleRoundButton(Icons.chat, () {
                              try {
                                launch("sms: +91 ${widget.lead.phoneNo[0]}");
                              } catch (e) {
                                print(e);
                              }
                            }),
                            buildSingleRoundButton(Icons.mail, () {
                              try {
                                launch("mailto: +91 ${widget.lead.email[0]}");
                              } catch (e) {
                                print(e);
                              }
                            }),
              ...
              delegate: SliverChildListDelegate([
                ...
                buildSingleRowTile(
                    ...
                    () {
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>AddTaskPage(selected: index,)));
                    },
